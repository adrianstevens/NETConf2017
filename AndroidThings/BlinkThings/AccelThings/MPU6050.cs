...
namespace Accel
{
    public class MpuSensorEventArgs : EventArgs
    {
        ...
        public SensorData[] Values { get; set; }
       ...
       // GpioController gpioController;
        ...
        byte ReadByte(byte regAddr)
        {
           ...
           // mpu6050.WriteRead(buffer, value);
            ...
            mpu6050.Write(value, value.Length);
            mpu6050.Read(buffer, buffer.Length);
        ...
        byte[] ReadBytes(byte regAddr, int length)
        {
           ...
           // mpu6050.WriteRead(buffer, values);
            ...
            mpu6050.Write(values, values.Length);
            mpu6050.Read(buffer, buffer.Length);
        ...
        void WriteByte(byte regAddr, byte data)
        {
            ...
            buffer[0] = regAddr;
            buffer[1] = data;
            mpu6050.Write(buffer, buffer.Length);
        }
        ...
        public async Task Init()
        {
            try
            {
                ...
                interruptPin = peripheralMgr.OpenGpio("IO12"); //Edison
                interruptPin.SetDirection(Gpio.DirectionIn);
             //   interruptPin.
